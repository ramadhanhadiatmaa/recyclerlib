package com.recyclerlibs.admob_advanced_native_recyvlerview;
...
import com.recyclerlibs.nativetemplates.NativeTemplateStyle;
import com.recyclerlibs.nativetemplates.TemplateView;
import com.recyclerlibs.rvadapter.RecyclerViewAdapterWrapper;
            ...
            AdLoader adLoader = new AdLoader.Builder(adHolder.getContext(), mParam.admobNativeId)
                    ...
                    .withAdListener(new AdListener() {
                        ...
                        public void onAdFailedToLoad(LoadAdError adError) {
                            Log.e("admobnative","error:"+adError);
